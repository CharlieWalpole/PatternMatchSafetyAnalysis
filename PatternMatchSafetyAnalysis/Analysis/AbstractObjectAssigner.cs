...
public class AbstractObjectIDAssigner(SemanticModel semanticModel) : CSharpSyntaxWalker
{
    ...
    public ImmutableDictionary<AbstractObjID, TextSpan> AbstractObjectIDsToCodeLocations { get {
    ...
    public ImmutableHashSet<(AbstractObjID, FieldName, IFieldSymbol)> HeapDomain { get {
